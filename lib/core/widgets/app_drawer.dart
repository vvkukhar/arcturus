      ...
      child: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            const Divider(),
            ListTile(leading: const Icon(Icons.account_balance), title: const Text('Arcturus Vault'), onTap: () => _open(context, AppRouter.vault)),
            ListTile(leading: const Icon(Icons.network_node), title: const Text('The Syndicate'), onTap: () => _open(context, AppRouter.syndicate)),
            ListTile(leading: const Icon(Icons.campaign), title: const Text('AI Marketing'), onTap: () => _open(context, AppRouter.marketing)),
            const Divider(),

...
class ItemModel {
  ...
  const ItemModel({required this.id, required this.title, required this.type, this.theme, this.setId, this.notes, required this.condition, required this.completeness, required this.ownershipType, required this.purchasePrice, required this.shippingToMe, required this.extraCosts, required this.totalCost, this.marketAverage, this.expectedSalePrice, this.actualSalePrice, required this.status, this.purchaseDate, this.saleDate, required this.isTracked, required this.quantity, this.imagePaths = const []});

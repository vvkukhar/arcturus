...
class ItemModel {
  ...
  factory ItemModel.fromMap(Map<String, dynamic> map) => ItemModel(
      id: map['id'],
      title: map['title'],
      type: ItemType.values.firstWhere((e) => e.name == map['type'], orElse: () => ItemType.set),
      theme: map['theme'],
      setId: map['setId'],
      notes: map['notes'],
      condition: ItemCondition.values.firstWhere((e) => e.name == map['condition'], orElse: () => ItemCondition.newSealed),
      completeness: ItemCompleteness.values.firstWhere((e) => e.name == map['completeness'], orElse: () => ItemCompleteness.complete),
      ownershipType: OwnershipType.values.firstWhere((e) => e.name == map['ownershipType'], orElse: () => OwnershipType.resale),
      purchasePrice: (map['purchasePrice'] ?? 0).toDouble(),
      shippingToMe: (map['shippingToMe'] ?? 0).toDouble(),
      extraCosts: (map['extraCosts'] ?? 0).toDouble(),
      totalCost: (map['totalCost'] ?? 0).toDouble(),
      marketAverage: map['marketAverage']?.toDouble(),
      expectedSalePrice: map['expectedSalePrice']?.toDouble(),
      actualSalePrice: map['actualSalePrice']?.toDouble(),
      status: ItemStatus.values.firstWhere((e) => e.name == map['status'], orElse: () => ItemStatus.purchased),
      purchaseDate: map['purchaseDate'] != null ? DateTime.tryParse(map['purchaseDate']) : null,
      saleDate: map['saleDate'] != null ? DateTime.tryParse(map['saleDate']) : null,
      isTracked: map['isTracked'] ?? true,
...
class PurchaseModel {
  ...
  PurchaseModel copyWith({String? id, int? soldQuantity}) => PurchaseModel(
        id: id ?? this.id,
        itemId: itemId,
        source: source,
        sourceUrl: sourceUrl,
  ...
  factory PurchaseModel.fromJson(Map<String, dynamic> map) => PurchaseModel(
      ...
      paymentMethod: PurchasePaymentMethod.values.firstWhere((e) => e.name == map['paymentMethod'], orElse: () => PurchasePaymentMethod.card),
...
class SaleModel {
  ...
  SaleModel copyWith({String? id, String? platform}) => SaleModel(
        id: id ?? this.id,
        itemId: itemId,
...
class WatchlistItemModel {
  ...
  WatchlistItemModel copyWith({String? id}) => WatchlistItemModel(
        id: id ?? this.id,
        title: title,
        type: type,
        theme: theme,
  ...
  factory WatchlistItemModel.fromMap(Map<String, dynamic> map) => WatchlistItemModel(
      ...
      marketPrice: map['marketPrice']?.toDouble(),

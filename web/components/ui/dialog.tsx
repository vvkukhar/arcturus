...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-6 top-6 rounded-full p-2 opacity-70 ring-offset-background transition-opacity hover:opacity-100 hover:bg-[var(--background)] focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:pointer-events-none data-[state=open]:bg-[var(--background)]">

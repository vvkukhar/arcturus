        ...
        {items.map((item) => {
          ...
          return (
            ...
            >
              ...
              <span>{['POS Terminal', 'Marketplace', 'Returns & Refunds', 'Marketplace Payouts', 'Supplier CRM', 'Demand Heatmap', 'Orders List'].includes(item.label) ? item.label : (isMounted ? t(item.label as any) : '...')}</span>
            </Link>
          );
        })}
      </nav>

...
export function ImageGalleryManager({ inventoryItemId, images }: Props) {
  ...
  const move = async (from: number, to: number) => {
    ...
    await fetch('/api/admin/media/inventory-image/reorder', {
      method: 'PATCH',
                ...
                <Button
                  ...
                  onClick={async () => {
                    try {
                      ...
                      await fetch('/api/admin/media/inventory-image/primary', {
                        method: 'PATCH',
                        headers: { 'Content-Type': 'application/json' },
              ...
              <Button
                ...
                onClick={async () => {
                  try {
                    ...
                    await fetch('/api/admin/media/inventory-image/delete', {
                      method: 'DELETE',
                      headers: { 'Content-Type': 'application/json' },
                      body: JSON.stringify({ imageId: image.id }),
                    });

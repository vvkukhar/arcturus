...
export function Footer() {
  ...
  return (
    <footer className="bg-[var(--card)] border-t border-[var(--border)] transition-colors duration-300 mt-auto z-10 relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 lg:gap-12">
          <div className="col-span-1 md:col-span-1">
            ...
            <div className="flex gap-4">
              <a href="#" className="text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors bg-[var(--background)] border border-[var(--border)] p-2 rounded-lg">
                <Instagram size={20} />
              </a>
              <a href="#" className="text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors bg-[var(--background)] border border-[var(--border)] p-2 rounded-lg">
                <Twitter size={20} />
              </a>
              <a href="mailto:contact@arcturus.store" className="text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors bg-[var(--background)] border border-[var(--border)] p-2 rounded-lg">
                <Mail size={20} />
              </a>
            </div>
          </div>
          ...
          <div>
            <h3 className="font-black text-[var(--foreground)] mb-4 uppercase text-xs tracking-widest">{t('footer.links' as any)}</h3>
          ...
          <div>
            <h3 className="font-black text-[var(--foreground)] mb-4 uppercase text-xs tracking-widest">{t('footer.contact' as any)}</h3>
            <ul className="space-y-3">
          ...
          <div>
            <h3 className="font-black text-[var(--foreground)] mb-4 uppercase text-xs tracking-widest">{t('footer.legal' as any)}</h3>
            <ul className="space-y-3">

...
export class MetricsService {
  ...
  async getDbHealth(): Promise<unknown> {
    ...
    const [
      ...
      this.prisma.activityLog.findFirst({ orderBy: { createdAt: 'desc' } }),
      this.prisma.marketListing.findFirst({ orderBy: { fetchedAt: 'desc' } }),
      this.prisma.decisionSnapshot.findFirst({ orderBy: { createdAt: 'desc' } }),
      this.prisma.sale.findFirst({ orderBy: { createdAt: 'desc' } }),
      this.prisma.order.findFirst({ orderBy: { createdAt: 'desc' } }),
      this.prisma.returnRequest.findFirst({ orderBy: { createdAt: 'desc' } }),
      this.prisma.expense.findFirst({ orderBy: { createdAt: 'desc' } }),
      this.prisma.reportSnapshot.findFirst({ orderBy: { createdAt: 'desc' } }),
      this.prisma.purchaseOrder.findFirst({ orderBy: { createdAt: 'desc' } }),
    ]);

...
export class QueueService {
  ...
  async enqueueMarketSnapshots(): Promise<unknown> {
    return this.marketQueue.add(JOB_NAMES.RECOMPUTE_MARKET_SNAPSHOTS, {}, {
  ...
  async enqueueDecisions(): Promise<unknown> {
    return this.decisionsQueue.add(JOB_NAMES.RECOMPUTE_DECISIONS, {}, {
      removeOnComplete: 100,
      removeOnFail: 500,
    });
  }
  ...
  async enqueueDealDetection(): Promise<unknown> {
    return this.decisionsQueue.add(JOB_NAMES.DETECT_DEALS, {}, {
      removeOnComplete: 100,
      removeOnFail: 500,
    });
  }
  ...
  async enqueueScheduledRefresh(): Promise<unknown> {
    return this.maintenanceQueue.add(JOB_NAMES.SCHEDULED_REFRESH, {}, {
      removeOnComplete: 100,
      removeOnFail: 500,
    });
  }

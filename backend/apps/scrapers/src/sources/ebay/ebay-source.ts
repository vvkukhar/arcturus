  ...
  try {
    ...
    for (const query of searchQueries) {
      ...
      for (const listing of listings) {
        ...
        creates.push(`('${listingId}', '${source.id}', 'ebay', '${itemId}', '${externalIdEscaped}', '${titleRawEscaped}', '${urlEscaped}', ${imgEscaped}, ${price}, ${currency}, ${shippingPrice}, ${shipCurrency}, ${condition}, ${sealed}, 'active', '${now}', '${now}')`);
